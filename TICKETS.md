...
| T10 | **PDF export alongside CSV/XLSX** | The artefact is already format-agnostic, so this is a new encoder rather than a new pipeline. A client-facing BOQ is expected as PDF. | T4 |
